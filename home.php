...
<body>
        ...
        <div class="container">
            ...
            <div class="gallery-section">
                ...
                <div class="image-gallery">
                    ...
                    <?php $p = getProductById($pid); $slug = $p ? getProductSlug($p) : $pid; ?>
    ...
    <section id="stone-types" class="products">
        <div class="container">
            ...
            <?php 
            // List of featured stone types to show on the homepage
            $stoneTypes = [
                ['id' => 'granite-rosa-beta', 'name' => 'Rosa Beta (Sardinia)'],
                ['id' => 'granite-g664-bainbrook-brown', 'name' => 'G664 (Bainbrook Brown)'],
                ['id' => 'granite-balmoral-red', 'name' => 'Balmoral Red'],
                ['id' => 'granite-g603', 'name' => 'G603'],
                ['id' => 'granite-viscount-white', 'name' => 'Viscount White'],
                ['id' => 'granite-vizag-blue', 'name' => 'Vizag Blue'],
                ['id' => 'granite-blue-pearl', 'name' => 'Blue Pearl'],
                ['id' => 'granite-multicolor-red', 'name' => 'Multicolor Red'],
                ['id' => 'granite-crema-julia', 'name' => 'Crema Julia'],
                ['id' => 'granite-emerald-pearl', 'name' => 'Emerald Pearl'],
                ['id' => 'granite-african-red', 'name' => 'Red Africa'],
                ['id' => 'granite-zimbabwe-black', 'name' => 'Zimbabwe Black'],
                ['id' => 'granite-star-galaxy', 'name' => 'Star Galaxy'],
                ['id' => 'granite-impala', 'name' => 'Impala'],
                ['id' => 'granite-rosa-porrino', 'name' => 'Rosa Porrino'],
                ['id' => 'granite-guna-black', 'name' => 'Guna Black'],
                ['id' => 'granite-shanxi-black', 'name' => 'Shanxi Black']
            ];
            ?>

            <div class="products-grid">
                <?php foreach ($stoneTypes as $stone): ?>
                <?php 
                // Get the product data to access the main image
                $product = getProductById($stone['id']);
                ?>
                <div class="product-item" data-category="granite">
                    <div class="product-image">
                        <?php if ($product && isset($product['main_image']) && $product['main_image']): ?>
                            <img src="images/<?php echo htmlspecialchars($product['main_image']); ?>" alt="<?php echo htmlspecialchars($stone['name']); ?>" style="width: 100%; height: 250px; object-fit: cover;">
                        <?php else: ?>
                            <div class="placeholder-image" style="width: 100%; height: 250px; background: linear-gradient(135deg, #3a3a3a 0%, #2a2a2a 100%); display: flex; align-items: center; justify-content: center; color: #b0b0b0;">
                                <div style="text-align: center;">
                                    ...
                                    <p><?php echo htmlspecialchars($stone['name']); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="product-info">
                        <h3><?php echo htmlspecialchars($stone['name']); ?></h3>
                        <a href="product.php?id=<?php echo $stone['id']; ?>" class="btn btn-primary"><?php echo t('view_product'); ?></a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
